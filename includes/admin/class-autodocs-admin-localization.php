    ...
    public static function publisher_config(AutoDocs_Settings $settings)
    {
        ...
        return array(
            ...
            'i18n' => array(
                ...
                'cronNextRunEstimate' => __('Estimated after you save settings.', 'autodocs-publisher'),
                'cronNextRunScheduled' => __('Currently scheduled.', 'autodocs-publisher'),
                'cronInLessThanMinute' => __('in less than a minute', 'autodocs-publisher'),
                'cronInSeconds' => __('in %d seconds', 'autodocs-publisher'),
                'cronInMinutes' => __('in %d minutes', 'autodocs-publisher'),
                'cronInHoursMinutes' => __('in %1$d hours %2$d minutes', 'autodocs-publisher'),
                'cronInDaysHours' => __('in %1$d days %2$d hours', 'autodocs-publisher'),
